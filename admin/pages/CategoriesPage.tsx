...
export const CategoriesPage: React.FC = () => {
  ...
  const renderCategoryCard = (category: Category) => (
    <div className="flex items-center gap-4">
      <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 text-3xl shadow-sm border border-primary-200">
        {category.icon || <Layers className="text-primary-200" />}
      </div>
      <div>
